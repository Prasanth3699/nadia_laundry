      ...
      <main className="min-h-screen bg-gray-50 dark:bg-black pt-24">
        <div className="container-custom">
          ...
          >
            ...
            >
              Experience premium laundry and dry cleaning services with modern
              technology, eco-friendly solutions, and exceptional care. From
              everyday essentials to specialized treatments, we deliver
          ...
          >
            <div
              className="glass-card rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6"
              style={{
                background:
                ...
                >
                  <motion.div
                    className={`glass-card border border-white/20 dark:border-gray-700/50 rounded-3xl overflow-hidden cursor-pointer relative ${
                      isSelected
                        ? "ring-2 ring-blue-500/50 bg-blue-50/50 dark:bg-blue-900/20"
                        : ""
                    }`}
                    onClick={() =>
                  ...
                  >
                    ...
                    <div className="relative h-56 overflow-hidden">
                      <PlaceholderImage
                        ...
                        fallbackText={getLocalizedText(service.title)}
                      />
                    ...
                    <div className="p-6 relative z-10">
                      ...
                      <div className="mb-6">
                        ...
                        >
                          {service.features
                            .slice(0, isSelected ? service.features.length : 4)
          ...
          >
            ...
            <p className="text-lg mb-6 opacity-90">
              Contact us for personalized laundry packages and commercial
              solutions
            </p>
            <Button
